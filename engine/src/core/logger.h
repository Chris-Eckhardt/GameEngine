...
#else//.. does nothing when warnings are disabled
...
#else//.. does nothing when info are disabled
...
#else//.. does nothing when debug are disabled
...
#else//.. does nothing when trace are disabled
