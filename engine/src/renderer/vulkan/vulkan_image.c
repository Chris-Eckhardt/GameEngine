...
void vulkan_image_create(
    ...
    image_create_info.extent.depth = 1;// TODO: support configurable depths
    ...
    image_create_info.sharingMode = VK_SHARING_MODE_EXCLUSIVE; // TODO: configuable sharing mode
